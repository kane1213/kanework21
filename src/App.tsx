...
export default () => {
  ...
  function recordEvent () {
    ...
    const stream = stageRef.current._canvas.current.captureStream(); // Capture canvas as a media stream
  ...
  function cardsAnimation (open: boolean = true) {
    bunnyRef.current.children.map((sprite: any, index: number, sprites: any) => {
